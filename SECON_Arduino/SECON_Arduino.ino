...
void decodeLED() {
    ...
    if(locations[0] == 0) state = TO_STAGE_A0;
    else state = TO_STAGE_A1;
}


//////////////////////////////////////////////////////////////////////////////////////
// Function: toStageA0()                                                            //
// Description: Navigates to stage A0                                               //
//////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////
// Function: toStageA1()                                                            //
// Description: Navigates to stage A1                                               //
//////////////////////////////////////////////////////////////////////////////////////

void toStageA1() {
    Serial2.println("D:TO_STAGE_A1");
    readMicroswitches();
...
void stageA() {
    ...
    if(locations[0] == 0) state = FROM_STAGE_A0;
    else state = FROM_STAGE_A1;
}
...
void toCenterOfCourse() {
    ...
    if(locations[1] == 0) state = TO_STAGE_B0;
    else state = TO_STAGE_B1;
}
